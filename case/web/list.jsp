...
<body>
<div class="container">
    <h3 style="text-align: center"><a href="${pageContext.request.contextPath}/findUserByPageServlet">用户信息列表</a></h3>
    <div style="float: left">
        <form class="form-inline" method="post" action="${pageContext.request.contextPath}/findUserByPageServlet">
            <div class="form-group">
                ...
                <input type="text" value="${condition.name[0]}" name="name" class="form-control" id="exampleInputName1">
            </div>
            <div class="form-group">
                <label for="exampleInputName2">籍贯</label>
                <input type="text" value="${condition.address[0]}" name="address" class="form-control" id="exampleInputName2">
            </div>
            <div class="form-group">
    ...
    <form id="form" method="post" action="${pageContext.request.contextPath}/delSelectServlet">
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${pb.list}" var="user" varStatus="s">
                <tr>
                    <td><input type="checkbox" name="sid" value="${user.id}"/></td>
                    <td>${s.count}</td>
                    <td>${user.name}</td>
                    <td>${user.gender}</td>
                    <td>${user.age}</td>
                    ...
                    <td><a class="btn btn-default btn-sm"
                           ...
                           onclick="return confirmUpdate();">修改</a>
